...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.FloatTensor(audio), torch.FloatTensor(vertice), torch.FloatTensor(template), torch.FloatTensor(
            one_hot), file_name
...
def read_data(args):
    ...
    print("train_data:", len(train_data), "valid_data:", len(valid_data), "test_data:", len(test_data))
